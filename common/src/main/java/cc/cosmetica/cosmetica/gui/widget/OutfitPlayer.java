...
//			guiPlayer.createNametag(Text.literal("test"), 0.75f);
		...
		guiPlayer.configureOverride(NametagConfigAttachment.LORE, this.lore == null ? NametagConfig.EMPTY : this.lore);
		...
		return Arrays.asList(
				new Div(
					...
					this.overrides.apply(guiPlayer).withStyle(Style.create()
							...
							.set(MIN_HEIGHT, fixedSize(90))
							.set(MAXIMUM_SIZE, fixed(new Dimensions(90, 180)))
							.set(HEIGHT, (vw, vh, pw, ph) -> OptionalInt.of(20 + (int)(2 * vw * 0.0625)))
